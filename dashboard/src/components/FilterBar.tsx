  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        ...
        className="bg-bg-input border border-border rounded-sm px-2 py-1.5 text-[0.75rem] text-text-primary focus:outline-none focus:border-border-hover appearance-none cursor-pointer"
      >
    ...
    <div className="space-y-3 animate-fade-in" style={{ animationDelay: "200ms", animationFillMode: "backwards" }}>
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-bg-input border border-border rounded-sm px-3 py-2.5 text-[0.8rem] text-text-primary placeholder:text-text-muted focus:outline-none focus:border-border-hover"
        />
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-1">
            <input
              ...
              placeholder="min"
              className="w-16 bg-bg-input border border-border rounded-sm px-2 py-1.5 text-[0.75rem] text-text-primary placeholder:text-text-muted focus:outline-none focus:border-border-hover"
            />
